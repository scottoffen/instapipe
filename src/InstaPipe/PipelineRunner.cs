...
#if NETSTANDARD2_0
    private static readonly DiagnosticListener DiagnosticListener = new($"InstaPipe.PipelineRunner<{typeof(T).Name}>");
#else
    private static readonly ActivitySource ActivitySource = new($"InstaPipe.PipelineRunner<{typeof(T).Name}>");
#endif
