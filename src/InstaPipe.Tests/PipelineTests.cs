...
public class PipelineTests
{
    ...
    public void Discover_OutputsRelevantLogs()
    {
        ...
        logger.ShouldContainMessage(string.Format(Pipeline.StepDiscoveredMessage, "InstaPipe.Tests.Steps.StepA1", 1, 1, true), LogLevel.Debug);
        logger.ShouldContainMessage(string.Format(Pipeline.StepDiscoveredMessage, "InstaPipe.Tests.Steps.StepB1", 2, 1, true), LogLevel.Debug);
        logger.ShouldContainMessage(string.Format(Pipeline.StepDiscoveredMessage, "InstaPipe.Tests.Steps.StepC1", 3, 1, true), LogLevel.Debug);
        logger.ShouldContainMessage(string.Format(Pipeline.StepDiscoveredMessage, "InstaPipe.Tests.Steps.StepD", 5, "(none)", true), LogLevel.Debug);
    }
